...
export const buttonVariants = {
  variant: {
    ...
    'link-foreground': 'text-foreground underline-offset-4 hover:underline',
    'link-muted':
...
export const buttonBaseStyles = cn(
  'inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-lg border border-transparent text-sm font-medium',
