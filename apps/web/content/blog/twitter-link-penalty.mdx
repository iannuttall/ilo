...
This is also where ilo is useful. Search your posts for domains or `filter:links` style patterns, group the results, and compare performance over time. [Connect X in ilo](/settings/connections) when you want the answer for your account rather than a recycled rule from someone else's timeline.
