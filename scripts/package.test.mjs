...
test('public API can be imported', async () => {
  ...
  assert.equal(typeof module.fetchPublicXFollowers, 'function')
  assert.equal(typeof module.fetchPublicXSearch, 'function')
  assert.equal(typeof module.fetchPublicXArticles, 'function')
  assert.equal(typeof module.fetchPublicXStatus, 'function')
